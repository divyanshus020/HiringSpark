...
import StepIndicator from '../components/job-posting/StepIndicator';
import JobDetailsStep from '../components/job-posting/JobDetailsStep';
      ...
      <main className="container py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600 text-center text-lg">
            Follow the steps below to create and post your job across multiple platforms
          </p>
        </div>
