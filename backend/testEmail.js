...
const testEmail = async () => {
  try {
    ...
    const info = await transporter.sendMail({
      from: `"HiringBazaar Test" <${process.env.EMAIL_USER}>`,
      to: process.env.EMAIL_USER, // Send to yourself for testing
      subject: '✅ Test Email - HiringBazaar Email System',
      html: `
        <div style="font-family: Arial, sans-serif; padding: 20px; background-color: #f4f7fa;">
          <div style="max-width: 600px; margin: 0 auto; background: white; padding: 30px; border-radius: 10px;">
            ...
            <p style="font-size: 16px; color: #4a5568;">
              Congratulations! Your HiringBazaar email notification system is configured correctly.
            </p>
            ...
            <p style="color: #718096; font-size: 14px;">
              This is a test email sent from HiringBazaar backend.
            </p>
          </div>
        </div>
      `
